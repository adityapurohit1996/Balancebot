...
float tgt_pts[32][3] = {{0.92, 0, 0}, {0, 0, 1.62}, {0, 0.94, 0}, {0, 0, 1.7}, {-0.85, 0, 0}, {0, 0, 1.57}, {0, -0.87, 0}, {0, 0, 1.75},
											 {0.92, 0, 0}, {0, 0, 1.62}, {0, 0.94, 0}, {0, 0, 1.7}, {-0.85, 0, 0}, {0, 0, 1.57}, {0, -0.87, 0}, {0, 0, 1.75},
											 {0.92, 0, 0}, {0, 0, 1.62}, {0, 0.94, 0}, {0, 0, 1.7}, {-0.85, 0, 0}, {0, 0, 1.57}, {0, -0.87, 0}, {0, 0, 1.75},
										   {0.92, 0, 0}, {0, 0, 1.62}, {0, 0.94, 0}, {0, 0, 1.7}, {-0.85, 0, 0}, {0, 0, 1.57}, {0, -0.87, 0}, {0, 0, 1.75}};
