...
// float tgt_pts[32][3] = {{0.92, 0, 0}, {0, 0, 1.65}, {0, 0.94, 0}, {0, 0, 1.7}, {-0.85, 0, 0}, {0, 0, 1.57}, {0, -0.87, 0}, {0, 0, 1.75},
// 											 {0.92, 0, 0}, {0, 0, 1.65}, {0, 0.94, 0}, {0, 0, 1.7}, {-0.85, 0, 0}, {0, 0, 1.57}, {0, -0.87, 0}, {0, 0, 1.75},
// 											 {0.92, 0, 0}, {0, 0, 1.65}, {0, 0.94, 0}, {0, 0, 1.7}, {-0.85, 0, 0}, {0, 0, 1.57}, {0, -0.87, 0}, {0, 0, 1.75},
// 										   {0.92, 0, 0}, {0, 0, 1.65}, {0, 0.94, 0}, {0, 0, 1.7}, {-0.85, 0, 0}, {0, 0, 1.57}, {0, -0.87, 0}, {0, 0, 1.75}};


float tgt_pts[32][3] = {{0.94, 0, 0}, {0, 0, -1.62}, {0, 0.97, 0}, {0, 0, -1.67}, {-0.94, 0, 0}, {0, 0, -1.57}, {0, -0.92, 0}, {0, 0, -1.69},
											 {0.92, 0, 0}, {0, 0, -1.62}, {0, 0.97, 0}, {0, 0, -1.67}, {-0.94, 0, 0}, {0, 0, -1.57}, {0, -0.92, 0}, {0, 0, -1.69},
											 {0.92, 0, 0}, {0, 0, -1.62}, {0, 0.97, 0}, {0, 0, -1.67}, {-0.94, 0, 0}, {0, 0, -1.57}, {0, -0.92, 0}, {0, 0, -1.69},
										   {0.92, 0, 0}, {0, 0, -1.62}, {0, 0.97, 0}, {0, 0, -1.67}, {-0.94, 0, 0}, {0, 0, -1.57}, {0, -0.92, 0}, {0, 0, -1.69}};
...
void* setpoint_control_loop(void* ptr){
	...
	while(1){
		...
		{
			float x,y;
				if ((counter < num_set_pts)&& (tgt_counter < 31))
				{
					x = mb_traj[counter].x;
					y = mb_traj[counter].y;
